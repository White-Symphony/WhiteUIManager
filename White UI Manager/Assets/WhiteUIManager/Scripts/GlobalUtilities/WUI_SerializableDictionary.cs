...
namespace WUI.Utilities
{
    ...
    public class WUI_SerializableDictionary {}
    
    [Serializable]
    public class WUI_SerializableDictionary<TKey, TValue> : WUI_SerializableDictionary, IDictionary<TKey, TValue>, ISerializationCallbackReceiver
    {
        ...
        public WUI_SerializableDictionary()
        {
            _keyPositions = new Lazy<Dictionary<TKey, uint>>(MakeKeyPositions);
        }
    
        public WUI_SerializableDictionary(IDictionary<TKey, TValue> dictionary)
        {
            _keyPositions = new Lazy<Dictionary<TKey, uint>>(MakeKeyPositions);
        ...
        {
            if (!KeyPositions.TryGetValue(key, out var index)) return false;
        ...
        public IEnumerator<KeyValuePair<TKey, TValue>> GetEnumerator()
        {
            ...
            KeyValuePair<TKey, TValue> ToKeyValuePair(SerializableKeyValuePair serializableKeyValuePair)
            {
